...
export const ItemsAvailable = (data) => {
  return (dispatch, getState) => {
    axios
      .post(
        `${process.env.REACT_APP_API_URL}api/v1/admin/product/edit_itemavailable`,data
      ).then((res) => {
        if (res.data.status === "success") {
...
export const getSingleAddon = (addon)=>{
  return (dispatch, getState) => {
    axios
      .get(`${process.env.REACT_APP_API_URL}api/v1/admin/product/get_single_addons?add_ons_id=${addon}`)
      .then((data) => {
        dispatch({
...
export const updateAddonProduct = (product) => {
  ...
  return (dispatch, getState) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_URL}api/v1/admin/product/update_addons`,product)
      .then((res) => {
...
export const deleteSingleAddon = (id)=>{
  return (dispatch, getState) => {
    axios
      .post(`${process.env.REACT_APP_API_URL}api/v1/admin/product/del_single_addons?add_ons_id=${id}`)
      .then((res) => {
    if (res.data.msg === "success") {
...
export const deleteCategory = (id)=>{
  return (dispatch, getState) => {
    axios
      .post(`${process.env.REACT_APP_API_URL}api/v1/admin/product/delete_category_list?id=${id}`)
      .then((res) => {
...
export const deleteProduct = (id)=>{
  return (dispatch, getState) => {
    axios
      .post(`${process.env.REACT_APP_API_URL}api/v1/admin/product/delete_product_list?id=${id}`)
      .then((res) => {
    if (res.data.msg === "deleted") {
      toast.success(`Deleted successfully`, {
        position: "top-right",
